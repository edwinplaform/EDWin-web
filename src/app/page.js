...
// import {CurrentRole} from "@/util/Role";
        ...
        return (
            <div>
                ...
                <div className="items-center justify-center flex flex-col my-5 h-32">
                    ...
                    <p className="font-light text-2xl text-darkGreen justify-center">Instant online tutoring - all
                ...
                <div>
                    <div className="flex flex-col sm:flex-row my-16 px-6 justify-between">
                        <div
                            className="ring-black ring-1 m-8 px-8 py-24 rounded items-center justify-center flex flex-col hover:shadow-2xl">
                            <h2 className="font-bold text-2xl text-gray-700 m-4">Flexible Schedule</h2>
                            <p className="text-sm text-gray-600 ">Organize your classes whenever you want with the
                                teacher you choose.</p>
                        </div>
                        <div
                            className="ring-black ring-1 m-8 px-8 py-24 rounded items-center justify-center flex flex-col hover:shadow-2xl">
                            <h2 className="font-bold text-2xl text-gray-700 my-4">Custom Classes</h2>
                            <p className="text-sm text-gray-600">Our teachers will adapt the classes according to your
                                level and needs.</p>
                        </div>
                        <div
                            className="ring-1 ring-black m-8 px-8 py-24 rounded items-center justify-center flex flex-col hover:shadow-2xl">
                            <h2 className="font-bold text-2xl text-gray-700 my-4">Choose your teacher</h2>
                            <p className="text-sm text-gray-600">Choose your teacher according to their profile and
                                reviews.</p>
                        </div>
                        <div
                            className="ring-black ring-1 m-8 px-8 py-24 rounded items-center justify-center flex flex-col hover:shadow-2xl">
                            <h2 className="font-bold text-2xl text-gray-700 my-4">Buy 1 class or several</h2>
                            <p className="text-sm text-gray-600">You can buy a package of 1, 5, or 100 classes as it
                                suits you. Without obligation.</p>
                        </div>
                    </div>
                </div>
