        ...
        const handleSubmit = async (e) => {
            ...
            try {
                ...
                if (result.error) {
                    ...
                    //
                    // if (session?.user) {
                    //     const {role, isOnboarding} = session.user;
                    //     if (role === "TUTOR") {
                    //         router.push(!isOnboarding ? "/tutor/onboarding" : "/portal/tutors/classes");
                    //     } else if (role === "STUDENT") {
                    //         router.push(!isOnboarding ? "/student/onboarding" : "/portal/students/classes");
                    //     } else if (role === "ADMIN") {
                    //         router.push("/portal/tutors");
                    //     } else {
                    //         router.push("/");
