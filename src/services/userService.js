...
export const updatePassword = async ({userId,password}) => {
    const response = await axiosInstance.patch(`/auth/${userId}/change-password`, password);
    return response.data;
};
...
export const updateBankDetails = async ({userId, bankDetails}) => {
    const response = await axiosInstance.patch(`/users/tutors/${userId}/bank`, bankDetails);
    return response.data;
};
